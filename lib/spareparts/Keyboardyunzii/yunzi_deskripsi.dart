...
class yunzidescription extends StatelessWidget {
  @override
            ...
            children: [
              ...
              AspectRatio(
                ...
                child: PageView(
                  children: [
                    Image.asset(
                        '../assets/images/sparepart/keyboardyunzii.jpeg',
                        fit: BoxFit.cover),
                    Image.asset(
                        '../assets/images/sparepart/keyboardyunzii_belakang.jpg',
                        fit: BoxFit.cover),
                  ],
                ),
              ),
              ...
              SizedBox(height: 5),
              Text(
                'YUNZII YZ87 75% Gasket Mechanical Keyboard',
              ),
              SizedBox(height: 20),
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      ...
                      final cartItem = CartItem(
                        ...
                        price:
                            'Rp 2.000.000', // Ensure the correct price is passed
                        rating: 4.8,
                      );
